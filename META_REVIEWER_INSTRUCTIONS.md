...
### Step 2 — Verify the Instagram connection (`instagram_business_basic`, `pages_show_list`, `pages_read_engagement`)
...
### Step 3 — Publish an Instagram feed post (`instagram_business_content_publish`)
...
### Step 4 — Publish an Instagram Story (`instagram_business_content_publish`)
1. New Post tab.
...
### Step 5 — Schedule a future Instagram post (`instagram_business_content_publish`)
...
### Step 7 — Verify data deletion (`instagram_business_basic`)
